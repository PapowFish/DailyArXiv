...
keywords = ["Video Retrieval", "Multimodal Retrieval", "Moment Localization"] # TODO add more keywords
...
f_is.write("---\n")
f_is.write("**Please check the [Github](https://github.com/PapowFish/DailyArXiv) page for a better reading experience and more papers.**\n\n")
